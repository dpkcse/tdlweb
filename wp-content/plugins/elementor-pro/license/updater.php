...
class Updater {
	...
	private function setup_hooks() {
		...
		// Disabled the update check filter
		// remove_filter( 'pre_set_site_transient_update_plugins', [ $this, 'check_update' ], 50 );

		// Suppress update notifications
		remove_action( 'after_plugin_row_' . $this->plugin_name, 'wp_plugin_update_row' );
		add_action( 'after_plugin_row_' . $this->plugin_name, function() {
